"""
Django settings for fulltest_108 project.
...
ROOT_URLCONF = 'fulltest_108.urls'
...
WSGI_APPLICATION = 'fulltest_108.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fulltest_108 API",
    "DESCRIPTION": "API documentation for fulltest_108 App",
    "VERSION": "v1",
}
